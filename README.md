...
Jump to: [Field Metadata](#field-metadata), [FAQs](#faqs), [Contact](#contact)
...
| **Comments**   |  For birds use formal MBBA breeding evidence statements found in file [OBACTIV_bird_strings.csv](OBACTIV_bird_strings.csv)     |
